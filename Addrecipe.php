...
<body>
    ...
    <script>
        ...
        function closeModalAndAdd() {
            if($('#v').val()!=='') {
                $('#video_value').val($('#v').val().replace('youtu.be/','/www.youtube.com/embed/').replace('/watch','/embed'));
                changeVideo($('#v').val().replace('youtu.be/','/www.youtube.com/embed/').replace('/watch','/embed'));
                $('#v').val('');
            }
            else if($('#i').val()!==''){
