<div class="anti-card row m-2 w-full" id="btnsPart">
    <button onclick="activateCardPart('all_analitic')" id="btnAll" class="btn btn-small menu-info-btn m-2 p-2">All</button>
    <button onclick="activateCardPart('vitamins')" id="btnVit" class="btn btn-small menu-info-btn m-2 p-2">Vitamins</button>
    <button onclick="activateCardPart('minerals')" id="btnMin" class="btn btn-small menu-info-btn m-2 p-2">Minerals</button>
</div>
