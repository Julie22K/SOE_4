<div class="anti-card row m-2 w-full j-c-be" id="btnsPart">
<div class="row">
...
<div class="row">
     <button onclick="$('#card_analitic').fadeOut('slow');"  class="btn btn-cancel btn-small menu-info-btn m-2 p-2">Сховати</button>
